...
import transformers
from transformers import GPT2Tokenizer, Re_gptConfig, is_flax_available, is_torch_available
...
if is_flax_available():
    ...
    from transformers.models.re_gpt.modeling_flax_re_gpt import FlaxRe_gptForCausalLM, FlaxRe_gptModel

if is_torch_available():
    import torch


class FlaxRe_gptModelTester:
    def __init__(
        self,
        parent,
        batch_size=14,
...
@require_flax
class FlaxRe_gptModelTest(FlaxModelTesterMixin, FlaxGenerationTesterMixin, unittest.TestCase):

    all_model_classes = (FlaxRe_gptModel, FlaxRe_gptForCausalLM) if is_flax_available() else ()
    all_generative_model_classes = (FlaxRe_gptForCausalLM,) if is_flax_available() else ()

    def setUp(self):
        self.model_tester = FlaxRe_gptModelTester(self)
    ...
    def test_batch_generation(self):
        ...
        model = FlaxRe_gptForCausalLM.from_pretrained("EleutherAI/gpt-neo-125M")
