# coding=utf-8
# Copyright 2022 The Eleuther AI and HuggingFace Inc. team.
#
...
"""Convert re_gpt checkpoint."""


import argparse
import json

from transformers import Re_gptConfig, Re_gptForCausalLM, load_tf_weights_in_re_gpt
...
def convert_tf_checkpoint_to_pytorch(tf_checkpoint_path, config_file, pytorch_dump_path):
    ...
    load_tf_weights_in_re_gpt(model, config, tf_checkpoint_path)
